...
public class DownloadActivity extends FragmentActivity {
        ...
        public void onResponse(byte[] response) {
            ...
            if (m_ssj == null) {
                ...
                try {
                    ...
                    m_progressDialog.setMax(m_urlsToDownload.size());
                ...
                int total = m_urlsToDownload.size();
                m_progressDialog.setProgress(total - m_numberOfResources);
    ...
    // For future reference (6/10/14 - feel free to delete when no longer useful)
    /* NEVER
